#=
File: CA_simulations.jl | Stroke Patient Triage Policy Simulation in California using MDPs
---------------------------------------------------------------
...
location_pool = shuffle([(row.Latitude, row.Longitude) for row in CSV.File("sampled_points/RI_points.csv")])
...
CSV.write("simulation_results/RI_simulation_results.csv", df)
println("Simulation results written to simulation_results/RI_simulation_results.csv")
